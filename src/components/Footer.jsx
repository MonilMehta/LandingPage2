      ...
      <div className="footer-content max-w-7xl px-8 md:px-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="contact-info">
            ...
            <div className="mb-4 contactdet">
              ...
              <Typography variant="body" className="mb-3 text-white">admissionexpress</Typography>
              <Typography variant="body" className="mb-3 text-white bodd"><strong>Mobile:</strong> +91-9821948429</Typography>
              <Typography variant="body" className="mb-3 text-white bodd "><strong>Email:</strong> <a href="mailto:admission@admissionexpress .com" className="text-white ml-4">admission@admissionexpress.com</a></Typography>
              <Typography variant="body" className="text-white ml-12"><a href="mailto:info@admissionexpress .com" className="text-white ml-5">info@admissionexpress.com</a></Typography>
            </div>
          </div>
        </div>
        <div className="mt-8 md:mt-12 flex items-center justify-between border-t border-blue-gray-50 py-4">
          <Typography variant="body" className="text-blue-gray-900 text-sm md:text-base">
            &copy; {currentYear} Admission Express . All Rights Reserved.
          </Typography>
